...
public class BaseAdapterListViewHolderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 2. 어댑터 생성
//        EfficientAdapter adapter = new EfficientAdapter(this, R.layout.row_of_base_adapter_list_view, COUNTRIES);
...
//        listView.setAdapter(adapter);
    ...
    class EfficientAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view = inflater.inflate(R.layout.row_of_base_adapter_list_view, null);
            ImageView iv = view.findViewById(R.id.iv_icon);
            TextView tv = view.findViewById(R.id.tv_text);
            iv.setImageResource(R.drawable.twotone_alarm_on_24);
