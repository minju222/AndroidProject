...
import com.scsa.andr.myapplication2.databinding.RowBinding;
...
//                            }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null) {
                RowBinding binding = RowBinding.inflate(LayoutInflater.from(XmlPullParserActivity.this));
...
//                    RowLinearBinding binding = RowLinearBinding.inflate(LayoutInflater.from(MainActivity.this));
            ...
            holder.title.setOnClickListener(v -> {
                Toast.makeText(XmlPullParserActivity.this, item.title+"clicked", Toast.LENGTH_SHORT).show();
            });
